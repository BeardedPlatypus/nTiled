...
SCENARIO("constructSLT should build a valid SLT when provided with a specific light",
         "[LightOctreeFull][SLTFull][SLTBuilder][constructSLT][SLTSizeTest]") {
  GIVEN("A SLTBuilder and a light") {
    glm::vec3 origin_octree = glm::vec3(-81.0,
                                        -61.0,
                                        -201.0);
    ...
    glm::vec4 light_position = glm::vec4(0.0, 20.0, 100.0, 1.0);
    double radius = 80.0;
